# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-27 14:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_name', models.CharField(blank=True, help_text='If no template name is provided "vue_page/default.html" will be used.', max_length=120, verbose_name='Template name')),
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='spages.SPage', verbose_name='Parent page')),
            ],
            options={
                'ordering': ['url'],
                'verbose_name': 'Page',
